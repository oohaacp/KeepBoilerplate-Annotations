...
public class NoteController
{
	...
	@Autowired
	Note note;
	NoteRepository noterobj;

	@RequestMapping(value = "/")
	public ModelAndView getAllNotes()
	{
		NoteRepository noterobject=new NoteRepository();
		ModelMap modelMap=new ModelMap();
		modelMap.addAttribute(noterobject.getAllNotes());
	...
	*/
	...
	{
		NoteRepository noterobj=new NoteRepository();
